...
def fetch_sales_data() -> list[dict]:
    ...
    sheet_name = os.environ.get("SPREADSHEET_NAME") or "GamerZone"
...
def generate_report(records: list[dict]) -> str:
    ...
    report = (
        f"☀️ Morning Report - GamerZone ☀️\n"
