"""GamerZone Agent Harness (S2.5 STEP 2).

Usage:
    python agent_harness.py --cmd "บันทึกขาย Steam Wallet 1000 บาท 1 ใบ ราคา 1060 บาท"
...
SYSTEM_INSTRUCTION = '''
You are GamerZone Card Shop Agent Router.
...
def main() -> int:
    load_dotenv()
    parser = argparse.ArgumentParser(description="GamerZone Agent Harness")
